...
@MapperScan(basePackages = "com.zhajinyi.funparty.test1", sqlSessionTemplateRef  = "test1SqlSessionTemplate")
public class TestDataSourceConfig {
	...
	public SqlSessionFactory test1SqlSessionFactory(@Qualifier("test1DataSource") DataSource dataSource) throws Exception {
		...
		bean.setTypeAliasesPackage("com.zhajinyi.funparty.pojo");
